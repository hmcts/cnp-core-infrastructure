...
module "consul" {
  ...
  image_uri                   = "/subscriptions/1c4f0704-a29e-403d-b719-b90c34ef14c9/resourceGroups/mgmt-vmimg-store-nonprod/providers/Microsoft.Compute/images/moj-centos-consul-041217-112919"
  location                    = "${var.location}"
  cluster_name                = "consul"
  lb_private_ip_address       = "${var.lb_private_ip_address}"
