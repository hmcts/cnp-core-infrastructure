...
module "consul" {
  ...
  image_uri                   = "/subscriptions/8999dec3-0104-4a27-94ee-6588559729d1/resourceGroups/mgmtvmimgstoreprd/providers/Microsoft.Compute/images/moj-centos-consul-07112017"
  location                    = "${var.location}"
  cluster_name                = "consul"
}
