...
properties([
    parameters([
        ...
        string(name: 'NETNUM', defaultValue: '', description: ' (Required IP Range) ÷ (2 power (32 – required bitmask) ). For example: To get 10.130.10.160/27, it would be (160) ÷ (2 power (32-27)) = (160) ÷ (32) = 5'),
